...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        ...
        return openAPI
                ...
                .addTagsItem(new Tag().name("Chat").description("채팅 API"))
                .addTagsItem(new Tag().name("Announcements").description("공지사항 API"))
                .addTagsItem(new Tag().name("Hospitals").description("병원 API"))
